...
$l['edit_setting_group_desc'] = "Tato sekce umožní upravení již nastavených skupin nastavení.";
...
$l['group_selection_box'] = "Výběr skupiny";
$l['group_selection_single'] = "Výběr jednotlivé skupiny";
$l['adminlanguage'] = "Výběr administračního jazyka";
$l['cpstyle'] = "Výběr kontrolního panelu";
$l['php'] = "Hodnocení PHP";
$l['type'] = "Typ";
$l['extra'] = "Extra";
...
$l['setting_groups'] = "Skupinové nastavení";
$l['bbsettings'] = "Nastavení";
$l['insert_new_setting_group'] = "Vložit novou skupinu nastavení";
$l['setting_group_setting'] = "Skupinové nastavení / Nastavení";
$l['order'] = "Pořadí";
$l['delete_setting_group'] = "Smazat skupinu nastavení";
$l['save_display_orders'] = "Uložit pořadí zobrazení";
$l['update_setting_group'] = "Aktualizovat skupiny nastavení";
$l['modify_setting'] = "Modifikovat upravení";
$l['search'] = "Hledat";
...
$l['confirm_setting_deletion'] = "Jste si naprosto jistý, že chcete smazat toto nastavení?";
...
$l['error_missing_title'] = "Nezadali jste název pro toto nastavení.";
...
$l['error_invalid_type'] = "Pro toto nastavení nebyl vybrán platný typ.";
...
$l['success_settings_updated'] = "Nastavení bylo úspěšně aktualizováno.";
$l['success_settings_updated_hiddencaptchaimage'] = '<div class="smalltext" style="font-weight: normal;">Všimněte si, že nastavení <strong>skryté pole CAPTCHA</strong> bylo obnoveno na <strong>{1}</strong> kvůli konfliktu s polem <strong>{2}</strong> v registračním formuláři.</div>';
...
$l['prefix_selection_box'] = "Výběrové pole prefixu";
$l['error_field_minnamelength'] = "Minimální délka jména nemůže být větší než maximální délka jména";
$l['error_field_minpasswordlength'] = "Minimální délka hesla nemůže být větší než maximální délka hesla";
$l['error_field_minpasswordlength_complex'] = "Minimální délka hesla nemůže být při použití složitých hesel menší než 3";
$l['error_admin_email_settings_empty'] = '<div class="smalltext" style="font-weight: normal;">Upozorňujeme, že <strong>e-mail administrátora</strong> nebyl uložen, protože toto nastavení nemůže být prázdné a musí obsahovat platnou e-mailovou adresu.</div>';
$l['success_settings_updated_username_method_conflict'] = '<div class="smalltext" style="font-weight: normal;">Upozorňujeme, že nastavení <b>Povolené metody přihlášení</b> nebylo aktualizováno, protože v současné době je povoleno registrovat e-maily vícekrát.</div>';
$l['success_settings_updated_minsearchword'] = '<div class="smalltext" style="font-weight: normal;">Upozorňujeme, že nastavení <strong>Minimální délky hledaného slova</strong> bylo upraveno tak, aby odpovídalo konfiguraci databázového systému.</div>';
