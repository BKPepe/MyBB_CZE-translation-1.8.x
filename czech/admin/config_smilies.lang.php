...
$l['manage_smilies_desc'] = "V této části můžete přidat, upravovat a smazat smajlíky.";
$l['add_smilie'] = "Přidat nového smajlíka";
$l['add_smilie_desc'] = "Zde můžete přidat jednoho smajlíka.";
$l['add_multiple_smilies'] = "Přidání více smajlíků najednou";
...
$l['image_path_desc'] = "Tady je cesta obrázku smajlíka. Chcete-li použít jiné obrázky smajlíků pro jiný vzhled fóra, prosím, použijte <strong>{theme}</strong>, což zastoupí složku smajlíků pro každý vzhled.";
$l['order'] = "Pořadí";
...
$l['show_clickable_desc'] = "Chcete, abyste mohli najít smajlíka při psaní příspěvku?";
$l['include'] = "Přidat?";
...
$l['error_missing_name'] = "Nezadali jste název pro tohoto smajlíka.";
$l['error_missing_text_replacement'] = "Nezadali jste <strong>Zobrazení v textu</strong> pro tohoto smajlíka.";
$l['error_missing_path'] = "Nezadali jste cestu pro tohoto smajlíka.";
$l['error_missing_path_multiple'] = "Nezadali jste cestu, kde se nachází smajlíci.";
$l['error_missing_order'] = "Nezadali jste pořadí smajlíka.";
$l['error_duplicate_order'] = "Zadali jste nesprávnou hodnotu pro zobrazení smajlíka.";
$l['error_missing_clickable'] = "Nevybrali jste ano/ne v možnosti pro \"Zobrazení ve výběru smajlíků v editoru příspěvků?\"";
$l['error_no_smilies'] = "Ve vybrané složce nejsou žádní smajlíci, nebo již byli všichni v minulosti přidáni.";
...
$l['error_invalid_path'] = "Zadali jste cestu, která neexistuje.";
...
$l['success_smilie_updated'] = "Smajlík byl úspěšně aktualizován.";
$l['success_multiple_smilies_updated'] = "Smajlíky si úspěšně upravil.";
$l['success_smilie_deleted'] = "Vybraný smajlík byl vymazán.";
$l['success_mass_edit_updated'] = "Smajlíci byly úspěšně upraveni.";
$l['confirm_smilie_deletion'] = "Opravdu chcete smazat tohoto smajlíka?";
