...
$l['time_minutes_desc'] = "Zadejte minuty (0-59) oddělené ',' (čárkou), ve kterých bude tato úloha spuštěna. Zadejte '*', pokud chcete, aby úloha běžela každou minutu.";
$l['time_hours'] = "Čas: Hodiny";
$l['time_hours_desc'] = "Zadejte hodiny (0-23) oddělené ',' (čárkou), ve kterých bude tato úloha spuštěna. Zadejte '*', pokud chcete, aby úloha běžela každou hodinu.";
$l['time_days_of_month'] = "Čas: Dny v měsíci";
$l['time_days_of_month_desc'] = "Zadejte dny oddělené ',' (čárkou), ve kterých chcete provést tuto úlohu. Zadejte '*', pokud chcete, aby úloha běžela každý den nebo vyber z nabídky den, která se nachází níže.";
...
$l['enable_logging'] = "Zapnout logování?";
