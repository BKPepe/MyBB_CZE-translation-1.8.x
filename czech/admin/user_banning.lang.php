...
// Tabs
$l['banning'] = "Banování uživatelů";
$l['banned_accounts'] = "Zabanované účty";
$l['banned_accounts_desc'] = "Zde můžete spravovat účty, kterým jste v minulosti odepřel přístup na fórum, případně můžete někomu odepřít přístup na fórum.";
$l['ban_a_user'] = "Zabanování uživatelé";
$l['ban_a_user_desc'] = "Zde můžete udělit uživateli ban.";
...
$l['confirm_prune'] = "Opravdu chcete smazat všechny příspěvky a témata založená tímto uživatelem?";
...
$l['ban_group_desc'] = "Aby vybraný uživatel byl zabanován, tak musí patřit do zabanované skupině.";
$l['ban_time'] = "Trvání banu <em>*</em>";

//= Index
$l['user'] = "Uživatel";
$l['moderation'] = "Moderátor";
$l['ban_lifts_on'] = "Ban upraven na";
$l['time_left'] = "Zbývá do vypršení banu";
$l['permenantly'] = "na trvalo";
$l['na'] = "N/A";
$l['for'] = "pro";
$l['bannedby_x_on_x'] = "<strong>{1}</strong><br /><small>Zabanovaný od {2} na {3} {4}</small>";
$l['lift'] = "Upravit";
$l['no_banned_users'] = "Prozatím nebyli zabanováni žádní uživatelé.";
$l['prune_threads_and_posts'] = "Smazat témata &amp; příspěvky";

// Buttons
$l['ban_user'] = "Zabanovat uživatele";
$l['update_ban'] = "Upravit ban";
