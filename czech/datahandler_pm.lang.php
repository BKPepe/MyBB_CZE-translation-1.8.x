...
$l['pmdata_message_too_long'] = 'Zpráva je příliš dlouhá. Prosím, napište zprávu kratší než {1} znaků (v současné době {2}).';
...
$l['pmdata_recipient_is_ignoring'] = "Nemůžete odeslat zprávu uživateli {1}, protože Vás má v seznamu ignorovaných uživatelů.";
$l['pmdata_recipient_has_buddy_only'] = "Nemůžete poslat zprávu příjemci {1}, protože Vás nemá ve svém seznamu přátel.";
$l['pmdata_recipient_pms_disabled'] = 'Uživatel {1}, kterému se pokoušíte zaslat soukromou zprávu, si tuto možnost vypnul. Vaše zpráva mu tedy nemůže být odeslána.';
...
$l['pmdata_pm_flooding_one_second'] = 'Pokoušíte se odeslat zprávu moc brzy po odeslání předchozí zprávy. Prosím, počkejte 1 sekundu.';
