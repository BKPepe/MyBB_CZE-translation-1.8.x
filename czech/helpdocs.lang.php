...
// Help Document 1
$l['d1_name'] = "Registrace uživatele";
...
<p>[email=example@example.com]Napiš mi![/email]<br />&nbsp;&nbsp;&nbsp;<a href=\"mailto:example@example.com\">Napiš mi!</a>
...
<p><br />[align=center]Centrovaný text[/align]<div align=\"center\">Centrovaný text</div>
<p>[align=right]Text zarovnaný doprava[/align]<div align=\"right\">Text zarovnaný doprava</div>
<p><br />[list]<br />[*]Položka seznamu #1<br />[*]Položka seznamu #2<br />[*]Položka seznamu #3<br />[/list]<br /><ul><li>Položka seznamu #1</li><li>Položka seznamu #2</li><li>Položka seznamu #3</li>
</ul>
<p>Můžete vytvořit tříděný seznam [list=1] číslovaný a [list=a] abecední.</p>";
