...
$l['ppd_percent_total'] = "{1} příspěvků za den | {2} procent z celkového počtu příspěvků";
$l['total_threads'] = "Celkem témat:";
$l['tpd_percent_total'] = "{1} témat za den | {2} procent z celkového počtu témat";
...
$l['verification_note'] = "Do textového pole dole zadejte text z obrázku. Toto opatření má zabránit robotům psát příspěvky.";
